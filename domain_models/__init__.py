...
from .food_ai_model import Food, UserRequestedFood # type: ignore
from .food_ai_model import UserRequestedFood , Food, CarbohydrateSource, MacroNutritionPerUnitOfMeasurement, UserLanguage  # type: ignore