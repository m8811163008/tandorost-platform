...
class EnvirenmentVariable:
    ...
    @staticmethod
    def CAFFE_BAZZAR_PURCHASE_PLAN_0() -> str:
        return os.environ.get("CAFFE_BAZZAR_PURCHASE_PLAN_0") or EnvirenmentVariable._raise_env_error("CAFFE_BAZZAR_PURCHASE_PLAN_0")
    @staticmethod
