...
class CacheModel():
    ...
    def system_instruction(cls):
        return f"""
                    If the input is audio, generate the transcription first.If the audio is empty or does not contain food and drink related subject then return empty list.
